  ...
  return (
    <div className="auth-page">
      <div className="auth-card">
        ...
        <a href="https://t.me/orlovee" target="_blank" rel="noopener noreferrer"
          style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, marginTop: 12, color: 'var(--info)', fontSize: 13 }}>
